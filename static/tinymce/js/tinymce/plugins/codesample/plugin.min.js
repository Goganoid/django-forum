! function() {
    ...
    "undefined" != typeof module && module.exports && (module.exports = r), "undefined" != typeof global && (global.Prism = r), r.languages.markup = {
            comment: /<!--[\w\W]*?-->/,
            prolog: /<\?[\w\W]+?\?>/,
            doctype: /<!DOCTYPE[\w\W]+?>/,
            cdata: /<!\[CDATA\[[\w\W]*?]]>/i,
        ...
        }), r.languages.js = r.languages.javascript, r.languages.c = r.languages.extend("clike", {
        ...
        }), delete r.languages.c["class-name"], delete r.languages.c["boolean"], r.languages.csharp = r.languages.extend("clike", {
        ...
        }), r.languages.insertBefore("csharp", "keyword", {
            preprocessor: {
                pattern: /(^\s*)#.*/m,
                lookbehind: !0
            }
        ...
        }), r.languages.markup && (r.hooks.add("before-highlight", function(t) {
            ...
            if ("php" === e.language) {
                for (var t = 0, a = void 0; a = e.tokenStack[t]; t++) e.highlightedCode = e.highlightedCode.replace("{{{PHP" + (t + 1) + "}}}", r.highlight(a, e.grammar, "php").replace(/\$/g, "$$$$"));
    ...
    var c = {
        ...
        p = function(t, a, n) {
            t.undoManager.transact(function() {
                var e = g(t);
                n = i.DOM.encode(n), e ? (t.dom.setAttrib(e, "class", "language-" + a), e.innerHTML = n, r.highlightElement(e), t.selection.select(e)) : (t.insertContent('<pre id="__new" class="language-' + a + '">' + n + "</pre>"), t.selection.select(t.$("#__new").removeAttr("id")[0]))
            })
        },
        f = function(e) {
            var t = g(e);
        ...
        v = function(a) {
            ...
            a.on("PreProcess", function(e) {
                i("pre[contenteditable=false]", e.node).filter(c.trimArg(c.isCodeSample)).each(function(e, t) {
                    var a = i(t),
                        n = t.textContent;
                ...
                var e = i("pre").filter(c.trimArg(c.isCodeSample)).filter(function(e, t) {
                ...
                e.length && a.undoManager.transact(function() {
                    e.each(function(e, t) {
                        ...
                        }), t.contentEditable = !1, t.innerHTML = a.dom.encode(t.textContent), r.highlightElement(t), t.className = i.trim(t.className)
                    })
                })
            })
        },
    ...
    e.add("codesample", function(t, e) {
        var a = n(!1);
        v(t), w(t), y(t), t.on("init", function() {
            k(t, e, x, a)
